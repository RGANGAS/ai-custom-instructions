...
Enhance your AI coding experience with enterprise-grade custom instructions that ensure consistency, quality, and alignment with  development standards. This repository provides curated instruction sets for popular programming languages and frameworks, designed to work seamlessly with GitHub Copilot, Windsurf, and other AI coding assistants. For a comprehensive overview
